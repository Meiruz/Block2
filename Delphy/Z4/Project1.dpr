...
Begin
    ...
    Writeln('Введите размерность 2M квадратной матрицы: ');
...
Begin
    ...
    Writeln(#10#13, 'Все значения матрицы должны быть от ', MIN_LIMIT, ' до ',
        MAX_LIMIT, '.');
    Writeln('Размеры квадратной матрицы 2M быть от ', MIN_LIMIT_SIZE, ' до ',
        MAX_LIMIT_SIZE, '.');

    Writeln(#10#13, 'Введите предпочитаемый тип ввода данных: ');
